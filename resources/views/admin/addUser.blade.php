...
<div class="p-6 sm:ml-64">
    <div class="p-8 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
        ...
        <h1 class="mb-2 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl lg:text-4xl dark:text-white">Make a <mark class="px-2 text-white bg-pink-600 rounded dark:bg-pink-500">Client</mark> for You...!</h1>
        <p class="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Create a new Client and Make Your's Superior One</p>
...
<br>
    ...
    <select id="role" name="role" class="px-3 py-1 text-sm border rounded-md focus:ring focus:ring-blue-300">
...
<br>
    <button id="submitForm" type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
  </form>
